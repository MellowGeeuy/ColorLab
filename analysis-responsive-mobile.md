...
| P0-2 drag-and-drop บนทัช | ⬜ **ยังไม่แก้** | งาน JS ~2 วัน ต้องทดสอบบนเครื่องจริง |
...
| P1-3 / P1-4 scale-strip · wheel | ⬜ ยังไม่แก้ | ไม่ล้นแล้ว แต่ยังบีบอยู่ |
...
**ทางเลือกสำรองที่ราคาถูกกว่า:** ถ้ายังไม่พร้อมรื้อ DnD ให้เพิ่ม "แตะเพื่อเลือก → แตะปลายทางเพื่อวาง"
เป็น interaction คู่ขนาน ใช้เวลา ~1 วัน และได้ผลพลอยได้คือผู้ใช้คีย์บอร์ดก็ทำได้ด้วย
