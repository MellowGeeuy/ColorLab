...
const SECTIONS = [
  ...
  },
  {
    ...
    title: 'Color Theory',
    icon: '#i-book',
    lead: '11 เรื่องที่ต้องรู้ก่อนเลือกสีให้งาน UI อธิบายด้วยภาพและอนิเมชัน',
    blocks: [
      {
        kind: 'list',
        title: 'อ่านยังไง',
        items: [
          ['สารบัญ', 'เมนูด้านข้างกระโดดไปหัวข้อไหนก็ได้ จอแคบกดปุ่มสารบัญบนแถบบนเพื่อเปิด'],
          ['แถบความคืบหน้า', 'เส้นบาง ๆ ใต้แถบบนบอกว่าอ่านมาถึงไหนแล้ว'],
      ...
      },
      {
        ...
        title: 'ลำดับเนื้อหา',
        items: [
          ['พื้นฐาน', 'สีทำงานก่อนตัวอักษร · สามแกนของสี'],
          ['ทฤษฎีสี', 'Color Models · วงล้อสีและ Harmony · สีกับความรู้สึก'],
